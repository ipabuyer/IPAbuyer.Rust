...
- `src-tauri/icons/icon-source.png` — 图标源文件（1000x1000，黑底无透明通道）；修改后运行 `npx tauri icon src-tauri/icons/icon-source.png -o src-tauri/icons` 重新生成整套图标并重新构建
